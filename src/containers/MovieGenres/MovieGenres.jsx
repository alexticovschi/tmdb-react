...
class MovieGenres extends Component {
  ...
  loadMore = async () => {
    ...
    const resp = await fetch(
      `https://api.themoviedb.org/3/discover/movie?with_genres=${ID}&api_key=${APIKEY}&page=${
        this.state.page
      }&sort_by=popularity.desc&primary_release_year=2018`
    );
      ...
      <div style={{ marginTop: "57px", minHeight: "60vh" }}>
        <div style={{ marginTop: "20px" }}>
          <main>
            <h1
              className="title"
              style={{ padding: "24px 0px", color: "#fff" }}
            >
